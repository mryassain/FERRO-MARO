...
{
	fiche *temp1 = new struct fiche,*temp2,*temp3;
	temp1->f2m.ModifBase(Base);
...
CTTFiche2Marche* CTTGestionF2M::ConsultFiche(int idparcours,int idtrain)
{
	struct fiche *temp1 = parcours[idparcours];
...
CTTGestionF2M::fiche* CTTGestionF2M::ConsultParcours(int index)
{
