...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(26, 35);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(114, 23);
			this->button1->TabIndex = 0;
			this->button1->Text = L"avant algorithme";
			...
			this->button2->Location = System::Drawing::Point(26, 64);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(114, 23);
			this->button2->TabIndex = 1;
			this->button2->Text = L"apres algorithme";
			...
			this->button3->Location = System::Drawing::Point(26, 93);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(114, 23);
			this->button3->TabIndex = 2;
			this->button3->Text = L"apres fixation";
			...
			this->label1->Text = L"tracer le graphique des fiches";
			// 
			// Form6
			// 
			...
			this->ClientSize = System::Drawing::Size(164, 127);
